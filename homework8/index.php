    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="serv.php" method="post" enctype="multipart/form-data">
                ...
                <input type="radio" name="authentication" class="custom-control-input" id="registration" value="reg" onclick="disableInput(this)" checked>
                <label class="custom-control-label" for="registration">Registration</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" name="authentication" class="custom-control-input" id="signIn" value="sign" onclick="disableInput(this)">
