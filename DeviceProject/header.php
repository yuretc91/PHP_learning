    ...
    <header>
        <div class="headerLogo"><img src="images/header/logo.png" alt="logo"></div>
        ...
        <ul class="headerSecondMenu">
            <li class="headerSecondMenuItem headerCatalog"><a href="#">КАТАЛОГ ТОВАРОВ</a> <img src="icons/header/plus.png" alt="plus"></li>
