    ...
    <header class="">
        ...
        <div id="cssmenu" class="align-center">
            <ul>
                ...
                <li class="has-sub"><a href="archive.php"><span>Blog</span></a>
                    <ul>
                ...
                <li class="active last"><a href="sign-in.php"><span>Sign in</span></a></li>
            </ul>
        </div>
        ...
        <div class="wrap-container">
            ...
            <section class="content-box zerogrid">
                <div class="row wrap-box"><!--Start Box-->
                    <h3 class="t-center" style="font-size: 30px;margin: 10px 0 30px">Sign in form</h3>

                    <div id="contact_form">

                        <form name="form1" id="ff" method="post" action="authorization.php">
                            <label class="row">
                                <div class="col-1-2">
                                    <div class="wrap-col">
                                        <input type="text" name="login" id="name" placeholder="Enter login" required="required" />
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-1-4 col-footer-3">
                    <div class="wrap-col">
                        ...
                        foreach ($tags as $tag):
                            ?>
                            <a href="single.php?tag=<?=$tag['id']?>"><?=$tag['tagName']?></a>
