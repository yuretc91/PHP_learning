            ...
            <div id="main-content">
                <div class="wrap-content">
                    <div class="row">
                        <article class="single-post zerogrid">
                            <div class="row wrap-post"><!--Start Box-->
                                ...
                                <div class="entry-header">
                                    <span class="time"><?=$post['date']?>  by <?=$post['author']?></span>
                                    <h2 class="entry-title"><a href="#"><?=$post['title']?></a></h2>
                                    <span class="cat-links"><a href="<?=$post['tagId']?>">BUSINESS</a>, <a href="#">LIFESTYLE</a></span>
                                </div>
                        ...
                        <div class="zerogrid commentsBlock">
                            <?php
