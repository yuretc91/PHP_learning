    ...
    <div class="row">
        <div class="col-12">
            ...
            <form action="serv.php" method="post">
                ...
                <input type="text" name="login" class="form-control mb-3" placeholder="login" required id="name">
...
<!--                <input type="text" name="email" class="form-control mb-3" placeholder="email" required>-->
                ...
                <input type="button" name="submit" class="btn btn-block btn-primary" id="btn">
            </form>
            <div class="hidden" style="display: none;">SUCCESS</div>
        </div>
    </div>
</div>
